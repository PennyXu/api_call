...
class P_chat_to_excel:
    def __init__(self,
                 api_key = "sk-5rkXkhDMZ2lJvj023cB6CaE84aB64375861a79D0E4709f96",
                 base_url = "https://hongtu-llm-gateway-test.t3go.net/v1"):
        self.help = '''
            ...
            try:
                ...
                completion = self.client.chat.completions.create(
                    ...
                    messages=[
                        ...
                        {'role': 'user', 'content': f'这有一句通话内容：{i}。{self.inquiry}。'}]
                )
